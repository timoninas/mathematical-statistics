...
| --- | --- | --- | --- |
| :one: | <ol> <li>Предельные теоремы теории вероятностей <li> Метод моментов <li> Метод максимального правдоподобия <li> Доверительные интервалы | [Отчет](https://github.com/timoninas/mathematical-statistics/blob/master/hw_1/hw_1.pdf) | :negative_squared_cross_mark: |
